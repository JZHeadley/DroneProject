...
import com.jzheadley.android_orientation_sensors.math.Matrix3x3;
import com.jzheadley.android_orientation_sensors.responseProvider.orientationResponseProvider;
...
public class Orientation implements Isensor, Observer {
    ...
    public boolean isSupport() {
        return accSensro.isSupport() && mgSensor.isSupport();
